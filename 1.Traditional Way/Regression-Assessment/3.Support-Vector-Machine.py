...
regressor = SVR(kernel = 'linear') #creating an instance of the SVR class with the kernel parameter set to 'rbf', which stands for Radial Basis Function. This kernel is commonly used in support vector machines and can capture non-linear relationships between the features and the target variable.
